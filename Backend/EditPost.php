...
{
    header('Location: ../edit-post.php?error='. urlencode("Er is iets misgegaan.") .'&postID='.$_GET['postID']);
}
...
try {
    ...
    header('Location: ../edit-post.php?error='.urlencode($exception->getMessage()).'&postID='.$_GET['postID']);
}